...
#ifndef soapsoapService_H
#define soapsoapService_H
#include "soapH.h"

    class SOAP_CMAC soapService {
      public:
        ...
        virtual void soapService_init(soap_mode imode, soap_mode omode);
        /// Return a copy that has a new managing context with the same engine state
        virtual soapService *copy() SOAP_PURE_VIRTUAL;
        /// Copy assignment
        soapService& operator=(const soapService&);
        ...
        virtual int getData(std::string name, DataRep &result) SOAP_PURE_VIRTUAL;
    };
#endif
